export interface StaticConfig {
    ...
    create_filter_type_list:            string[];
...
export interface CommonShopPriceList {
    CN:     Array<Array<number | string>>;
    Global: Array<Array<number | string>>;
...
export type MaterialType = "Material" | "Special";

export interface CurrentGameActivity {
    CN:     Array<Array<number | string> | number | string> | number | null | string;
    Global: Array<Array<number | string> | number | string> | number | null | string;
    JP:     Array<Array<number | string> | number | string> | number | null | string;
}
...
const typeMap: any = {
    "StaticConfig": o([
        ...
        { json: "create_filter_type_list", js: "create_filter_type_list", typ: a("") },
